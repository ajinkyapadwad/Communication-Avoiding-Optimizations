...
if __name__ == '__main__':
    ...
    DATA_DIR = '/home/ajinkyapadwad/spark-2.2.0/bin'

    train = spark.read.format("libsvm").load(os.path.join(DATA_DIR, "kdda.t"), numFeatures=N_FEATURES)\
            .withColumn("id", f.monotonically_increasing_id())
    print(train.show())
    valid = spark.read.format("libsvm").load(os.path.join(DATA_DIR, "kdda.t"), numFeatures=N_FEATURES) \
            .withColumn("id", f.monotonically_increasing_id())
